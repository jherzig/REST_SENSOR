...
abstract class ApiController
{
	...
	private function checkToken()
	{
		...
		throw new ApiException('access denied function checkToken()', ApiException::AUTHENTICATION_FAILED);
	}
	...
	private function checkIpAddress()
	{
		...
		throw new ApiException('access denied function checkIpAddress()', ApiException::AUTHENTICATION_FAILED);
	}
}